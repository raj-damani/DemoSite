...
<section>
    ...
    <div class="signinpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="signin-info">
                    ...
                    <ul>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Social media</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Educational media</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Professional media</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Grow your network today</li>
        ...
        <div class="signup-footer">
            <div class="pull-left">
                &copy; 2014. All Rights Reserved.             </div>
